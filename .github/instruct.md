...
| 階段        | 任務                                          | 狀態 |
| :---------- | :-------------------------------------------- | :--- |
| **Phase 1** | 基礎建設：Next.js + Supabase + Auth           | ✅   |
| **Phase 2** | 使用者系統：登入/登出 + 角色權限 + Middleware | ✅   |
| **Phase 3** | Admin 功能：助教管理 + 考試建立               | ✅   |
| **Phase 4** | 批量上傳：拖曳上傳 + 助教分配                 | ⬜   |
| **Phase 5** | TA 儀表板：待批改清單 + 統計                  | ⬜   |
| **Phase 6** | 批改介面：DOCX 預覽 + 評分表單                | ⬜   |
| **Phase 7** | 畫記功能：Fabric.js Canvas                    | ⬜   |
| **Phase 8** | GitHub Actions：Cppcheck 分析                 | ⬜   |
| **Phase 9** | 測試與優化                                    | ⬜   |

### 10.2 剩餘工作清單 (Remaining TODO)
